          ...
          <div class="row row-cols-1 row-cols-lg-2">
            <div class="col overflow-hidden mb-4">
              <div class="position-relative">
                <img
                  class="w-100 bg-brightness"
                  src="https://images.unsplash.com/photo-1633409361618-c73427e4e206?q=80&w=1160&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt=""
                />
                <div
                  class="position-absolute top-50 start-50 -translate-middle-x translate-middle z-1 w-75 text-center"
                >
                  <h1 class="text-white fs-1">We Are Acme Shop</h1>
                  <p class="fs-5">
                    <i class="text-white"
                      >Awesome clean & creative HTML5 & Template</i
                    >
                  </p>
                  <button
                    class="btn btn-outline-light mt-2 py-2 px-4 rounded-0"
                  >
                    Purchase Now!
                  </button>
                </div>
